...
- Adhere to Hugo Book's organizational structure (content resides in the `content/` directory). Specifically, use `content/docs` for documentation and `content/posts` for blog posts.
